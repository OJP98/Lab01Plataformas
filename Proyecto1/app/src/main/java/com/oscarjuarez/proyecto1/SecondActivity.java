...
public class SecondActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView viewNombre = findViewById(R.id.nombre_activity2);
        viewNombre.setText("El nombre del contacto es: " + getNombre);

        TextView viewApellido = findViewById(R.id.apellido_activity2);
        viewApellido.setText("El apellido es: " + getApellido);

        TextView viewTelefono = findViewById(R.id.numero_activity2);
